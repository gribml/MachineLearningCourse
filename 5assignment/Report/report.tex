...
\item To adjust the significance level to take into account the fact that we are doing multiple comparisons, we used $\alpha = 0.05 / k$, where $k = 2$ since for each model, we are making 2 comparisons each time.
